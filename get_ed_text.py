...
if __name__ == '__main__':
    ...
    save_npy(situations, save_path.format('situation_texts', split))
    save_npy(questions, save_path.format('question_texts', split))
    save_npy(answers, save_path.format('answer_texts', split))
